...
function PrivacyPolicy() {
 ...
 <div className='allExceptHeading'>
      <p> Please read the following Privacy policy of the services made available on <button>www.pw.live</button> or the equivalent 
...
the Services are availed may together be referred to for convenience as the “Platform”.</p>
      <p>Please ensure that this Privacy Policy is perused by You before availing any services from Us. This Privacy 
...
and protecting Your privacy, please keep reviewing this Policy.</p>
      <p>By viewing the PW Platform, you agree to be bound by the terms of this Privacy Policy.</p>
      <p>By using the PW Platform and/or by providing Your information, You consent to the collection and use of 
...
of the following nature</p></div>
      <div><p><ul type= "disc"></ul> Name</p></div>
      <div><p><ul type= "disc"></ul> Telephone Number</p></div>
      <div><p><ul type= "disc"></ul> Email Address</p></div>
      <div><p><ul type= "disc"></ul> Service Address</p></div>
      <div><p><ul type= "disc"></ul> Other information about the service address which You give Uy</p></div>
      <div><p><ul type= "disc"></ul> Your IP address</p></div>
      <div><p><ul type= "disc"></ul> Information about your device</p></div>
      <div><p><ul type= "disc"></ul> Network information</p></div>
      <div><p><ul type= "disc"></ul> College/ Institution Details and location</p></div>
      <div><p><ul type= "disc"></ul> User uploaded photo and IDs</p></div>
      <div><p><ul type= "disc"></ul> Demographic information such as postcode, preferences and interests</p></div>
      <div><p><ul type= "disc"></ul> Any other personal information which you give us in connection while booking a service or is relevant to 
customer surveys and/or offers.</p></div>
      
      <p>1.2 Information provided during Registration to create a profile and use this Website and services, you may 
...
You may also choose to provide a picture to be associated with your profile</p>
      <p>1.3 We also provide an option to register using Facebook. If you select this option, you allow us to access 
...
through Facebook, You shall be subject to the Terms & Conditions and Privacy Policy of Facebook.</p>
      <p>1.4 We will store your username, country and specialty on an unencrypted server. Your password is 
...
administering your use of the Application.</p>
      <div><p>1.5 You are solely responsible for</p></div>
      <div><p>1. maintaining the strict confidentiality of your Personal User Information</p></div>
      <div><p>2. not allowing another person to use your Personal User Information to access the Services</p></div>
      <div><p>3. any and all damages or losses that may be incurred or suffered as a result of any activities that occur in 
your Account</p></div>
    <div><p>4. ensuring that the information submitted by you complies with our terms and conditions</p></div>
    <div><p>5. ensuring that the information provided by you is correct and updated from time to time.</p></div>
      
    <p>1.6 You agree to immediately notify PW in writing by email to support@pw.live of any unauthorized use of 
...
person or entity.</p>
    <p>1.7 On receiving personal information about You, You no longer remain anonymous to Us. We may use this 
...
or not to provide such information to Us.</p>
    <p>1.8 You may choose not to provide us with any personal information or information as required to provide 
...
Service. Service shall have the meaning attributed to the phrase in the Terms of Use.</p>
    <p>1.9 On our Website, you can browse without telling Us who you are or revealing any personal information 
...
information, and Your IP address.</p>
    <p>1.10 On our Websites, We use data collection devices such as "cookies" on certain pages to help analyse 
