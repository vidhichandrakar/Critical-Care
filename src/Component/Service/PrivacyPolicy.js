    ...
    <div className="allPrivacyPolicy">
      ...
      <div className="allExceptHeading">
        <p>
          ...
          available on <button>www.pw.live</button> or the equivalent PW Mobile
          Application available on Google Play, ("PW App”/ “Website”). The PW
          App or Website on which the Services are availed may together be
          referred to for convenience as the “Platform”.
        </p>
        <p>
        ...
        <p>
          ...
          our Website in accordance with this Privacy Policy, including but not
          ...
          disclose it. If You do not agree for the forgoing, please do not
